...
function updateDatabase() {
    ...
    for (var i = 1; i <= questionNum; i++) {
        ...
        var feedback = document.getElementById('feedback' + i).value;
        questions.push({ "question": question, "answers": answers, "correct": correct, "feedback": feedback })
    }
...
function addQuestion() {
    ...
    var feedbackLabel = document.createElement('feedback');
    ...
    feedbackField.setAttribute('id', 'feedback' + String(questionNum));
    feedbackField.setAttribute('class', 'feedback');
    ...
    newQuestionDiv.appendChild(document.createElement('br'));
    newQuestionDiv.appendChild(document.createElement('br'));
    newQuestionDiv.appendChild(feedbackLabel);
    newQuestionDiv.appendChild(feedbackField);
...
function cancelQuiz() {
    if (confirm("Estás seguro que deseas cancelar el cuestionario? Se borrarán todas las preguntas!")) {
